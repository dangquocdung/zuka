...
class Zuka_Init{
    ...
    public function load_textdomain(){
        load_theme_textdomain( 'zuka', Zuka::$template_dir_path . '/languages' );
        load_child_theme_textdomain( 'zuka', Zuka::$stylesheet_dir_path . '/languages' );
    }
    ...
    public function add_theme_supports(){
        ...
        if(Zuka()->settings()->get('woocommerce_gallery_zoom') == 'yes'){
            add_theme_support( 'wc-product-gallery-zoom');
        }
        if(Zuka()->settings()->get('woocommerce_gallery_lightbox') == 'yes'){
    ...
    public function widget_init(){
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Widget Area', 'admin-view', 'zuka' ),
            'id'            => 'sidebar-primary',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Shop Filter', 'admin-view', 'zuka' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Aside Header Widget Area', 'admin-view', 'zuka' ),
            'description'   => esc_attr_x( 'Content of Aside Header component', 'admin-view', 'zuka' ),
            'id'            => 'aside-widget',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Header Bottom Widget Area', 'admin-view', 'zuka' ),
            'description'   => esc_attr_x( 'Apply for only header layout 4,5,6,7', 'admin-view', 'zuka' ),
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Top Area', 'admin-view', 'zuka' ),
            'id'            => 'footer_top_area',
            'description'   => esc_attr_x( 'It will be display if value of "Enable Footer Top Area" is "Yes"', 'admin-view', 'zuka' ),
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 1', 'admin-view', 'zuka' ),
            'id'            => 'f-col-1',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 2', 'admin-view', 'zuka' ),
            'id'            => 'f-col-2',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 3', 'admin-view', 'zuka' ),
            'id'            => 'f-col-3',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 4', 'admin-view', 'zuka' ),
            'id'            => 'f-col-4',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 5', 'admin-view', 'zuka' ),
            'id'            => 'f-col-5',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar( array(
            'name'          => esc_attr_x( 'Footer Widget Area Column 6', 'admin-view', 'zuka' ),
            'id'            => 'f-col-6',
            'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="widget-inner">',
            'after_widget'  => '</div></div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Top', 'admin-view', 'zuka' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Top', 'admin-view', 'zuka' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Bottom', 'admin-view', 'zuka' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Bottom', 'admin-view', 'zuka' ),
        ...
        if(function_exists('dokan')){
            register_sidebar(
                array(
                    'name'          => __( 'Dokan Store Sidebar', 'zuka' ),
                    'id'            => 'sidebar-store',
                    'before_widget' => '<div id="%1$s" class="widget %2$s">',
                    'after_widget'  => '</div>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block After Add To Cart', 'admin-view', 'zuka' ),
            'description'   => esc_attr_x( 'Display custom block on single product page', 'admin-view', 'zuka' ),
        ...
        $dynamic_sidebar = Zuka()->settings()->get('add_sidebars');
        if(!empty($dynamic_sidebar)){
            foreach($dynamic_sidebar as $sidebar){
                ...
                register_sidebar(array(
                    ...
                    'description'   => sprintf(_x('ID:{{%s}} ', 'admin-view', 'zuka'), sanitize_title($sidebar['sidebar_id'])) . (!empty($sidebar['sidebar_desc']) ? esc_html($sidebar['sidebar_desc']) : ''),
                    'before_widget' => '<div id="%1$s" class="widget %2$s">',
                    'after_widget'  => '</div>',
                    'before_title'  => '<h3 class="widget-title"><span>',
                    'after_title'   => '</span></h3>',
