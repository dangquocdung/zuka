...
class Zuka_Setting{
    ...
    public function __construct( $args = array() ) {
        $this->args = array_merge(array(
            'option_name'       => Zuka::get_option_name(),
            'post_meta_name'    => Zuka::get_original_option_name(),
            'term_meta_name'    => Zuka::get_original_option_name()
        ), $args);
    }
    ...
    public function get( $key = '', $default = '' ){
        ...
        return apply_filters("zuka/setting/option/get_single", $value, $key );
    }
    ...
    public function get_setting_by_context( $key, $default = '', $context = array()){
        ...
        if(in_array('is_home', $context)){
            ...
            if(!empty($_value)){
                if(is_array($_value)){
                    if(Zuka_Helper::is_not_empty_array_ref($_value)){
                        $value = $_value;
                    }
                }else{
                    if($_value !== 'inherit'){
        ...
        elseif(in_array('is_archive', $context)){
            ...
            if(in_array('is_shop', $context)){
                ...
                if(Zuka()->get_page_id()){
                    $_value = $this->get_post_meta( Zuka()->get_page_id(), $key);
                    if(!empty($_value)){
                        if(is_array($_value)){
                            if(Zuka_Helper::is_not_empty_array_ref($_value)){
                                $value = $_value;
        ...
        return apply_filters('zuka/setting/get_setting_by_context', $value, $key, $context);
    }
