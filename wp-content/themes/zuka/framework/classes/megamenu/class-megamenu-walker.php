...
if(!class_exists('Zuka_MegaMenu_Walker')){

    class Zuka_MegaMenu_Walker extends Walker_Nav_Menu {
            ...
            if ($depth == 0) {
                ...
                if ($item->menu_type == "wide") {
                    ...
                    if(isset($item->popup_background)){
                        ...
                        $popup_custom_styles .= Zuka_Helper::render_background_atts($popup_background, false);
                    }
