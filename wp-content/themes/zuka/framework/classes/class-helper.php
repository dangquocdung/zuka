...
if(!class_exists('Zuka_Helper')){
    ...
    class Zuka_Helper{
        ...
        public static function render_background_atts($options, $echo = true){
            ...
            if($echo){
                echo zuka_render_variable($return);
            }
            else{
                return $return;
            }
        ...
        public static function render_access_component( $type, $component = array(), $parent_name = '', $css_class = ''){
            ...
            if(!empty($component['text'])){
                $current_user_name = __('Guest', 'zuka');
            ...
            switch($type){
                ...
                case 'text':
                    ...
                    if(!empty($component['text'])){
                        ...
                        $target_html .= apply_filters('zuka/filter/component/text', $component['text']);
                        $target_html .= '</span>';
                        $target_html .= '</span>';
                    }
                    else{
                ...
                case 'link_text':
                    ...
                    if(!empty($component['text'])){
                        $icon_html .= '<span class="component-target-text">'. apply_filters('zuka/filter/component/text', $component['text']) .'</span>';
                    }
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
        ...
        public static function is_enable_image_lazy(){
            return apply_filters('zuka/image/use_lazy_load', false);
        }
