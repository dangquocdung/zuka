 ...
 * @return array
 */
function zuka_metaboxes_section_layout( $sections )
{
    $sections['layout'] = array(
        ...
        'fields'    => array(
            ...
            array(
                'id'            => 'sidebar',
                'type'          => 'select',
                'title'         => esc_html_x('Override Sidebar', 'admin-view', 'zuka'),
                'desc'          => esc_html_x('Select sidebar that will display on this page.', 'admin-view', 'zuka'),
                'class'         => 'chosen',
                'options'       => 'sidebars',
                'default_option'=> esc_html_x('Inherit', 'admin-view', 'zuka'),
                'dependency'    => array('layout_col-1c', '!=', '1')
            ),
            array(
                'id'            => 'main_menu',
                'type'          => 'select',
                'title'         => esc_html_x('Main Menu','admin-view', 'zuka'),
                'class'         => 'chosen',
                'options'       => 'tags',
                'query_args'    => array(
                    'orderby'   => 'name',
