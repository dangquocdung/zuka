...
$catalog_column = Zuka()->settings()->get('woocommerce_catalog_columns', Zuka()->settings()->get('woocommerce_shop_page_columns'));
...
$catalog_class[] = zuka_render_grid_css_class_from_columns($catalog_column);

if ( zuka_wc_product_loop() ) {
