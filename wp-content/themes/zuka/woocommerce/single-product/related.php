...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Zuka()->settings()->get('related_products_columns')
	);
	...
	$title = Zuka()->settings()->get('related_product_title') ? Zuka()->settings()->get('related_product_title') : _x( 'Related Products', 'front-view', 'zuka' );
	$sub_title = Zuka()->settings()->get('related_product_subtitle') ? Zuka()->settings()->get('related_product_subtitle') : '';
	?>
