...
<?php
	...
	$product_cols = shortcode_atts(
		...
		Zuka()->settings()->get('crosssell_products_columns')
	);
	...
	$title = Zuka()->settings()->get('crosssell_product_title') ? Zuka()->settings()->get('crosssell_product_title') : _x( 'You may be interested in&hellip;', 'front-view', 'zuka' );
	$sub_title = Zuka()->settings()->get('crosssell_product_subtitle') ? Zuka()->settings()->get('crosssell_product_subtitle') : '';
