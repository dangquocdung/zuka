...
$loop_index         = absint(zuka_get_theme_loop_prop('loop_index', 0));
$loop_index2        = absint(zuka_get_theme_loop_prop('loop_index2', 0));
$image_size         = zuka_get_theme_loop_prop('image_size', 'full');
$title_tag          = zuka_get_theme_loop_prop('title_tag', 'h3');
$item_sizes         = zuka_get_theme_loop_prop('item_sizes', array());
        ...
        <div class="loop__item__inner2">
            ...
            <div class="loop__item__info">
                <div class="loop__item__info2">
                    <?php
                    if($style != 8){
                        echo zuka_get_the_term_list(get_the_ID(), 'la_portfolio_skill', '<div class="loop__item__termlink">', '', '</div>', 3);
                    }?>
                    ...
                    <div class="loop__item__desc">
                        <?php echo zuka_get_the_excerpt(10); ?>
                    </div>
                    <div class="loop__item__meta--footer">
                        <a class="btn-readmore" href="<?php the_permalink(); ?>"><?php echo esc_html_x('Read more', 'front-end', 'zuka');  ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
zuka_set_theme_loop_prop('loop_index2', $loop_index2);