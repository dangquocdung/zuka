...
extract(shortcode_atts(array(
    'advanced_opts' => '',
    'tag_label' => esc_html_x('Tags', 'front-end', 'zuka'),
    'client_label' => esc_html_x('Client', 'front-end', 'zuka'),
    'client_value' => '',
    'category_label' => esc_html_x('Category', 'front-end', 'zuka'),
    'date_label' => esc_html_x('Date', 'front-end', 'zuka'),
    'date_value' => '',
    'share_label' => esc_html_x('SHARE', 'front-end', 'zuka'),
    'el_class' => ''
), $atts));
...
<div class="pf-info-wrapper <?php echo esc_attr($el_class) ?>">
    ...
    <?php if(in_array('share', $opts)):?>
        <div class="la-sharing-single-portfolio">
            ...
            <?php
                zuka_social_sharing(get_the_permalink($post->ID), get_the_title($post->ID), (has_post_thumbnail($post->ID) ? get_the_post_thumbnail_url($post->ID, 'full') : ''));
            ?>
        </div>
    <?php endif;?>
</div>
