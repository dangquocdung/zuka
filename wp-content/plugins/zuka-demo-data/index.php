<?php
/*
Plugin Name:    Zuka Package Demo Data
...
class Zuka_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'zuka';

    public static $demo_site = 'https://zuka.la-studioweb.com/';
...
if(Zuka_Data_Demo_Plugin_Class::isLocal()){
    include_once 'other-hook.php';
}

add_action('plugins_loaded', array('Zuka_Data_Demo_Plugin_Class','get_instance') );