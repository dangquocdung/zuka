...
<div class="lahfb-modal-wrap lahfb-modal-edit" data-element-target="search">
    ...
    <div class="lahfb-modal-header">
        <h4><?php esc_html_e( 'Search Settings', 'lahfb-textdomain' ); ?></h4>
            ...
            <div class="lahfb-tab-panel lahfb-group-panel" data-id="#general">
                ...
                lahfb_select( array(
                    ...
                    'options'		=> array(
                        ...
                        'slide'  => esc_html__( 'Slide (Vertical)', 'lahfb-textdomain' ),
                ...
                lahfb_switcher( array(
                    'title'         => esc_html__( 'Is Product Search?', 'lahfb-textdomain' ),
                ...
                lahfb_textfield( array(
                    'title'			=> esc_html__( 'Placeholder Text', 'lahfb-textdomain' ),
                    'id'			=> 'placeholder_text',
                    'default'		=> '',
                ));
                ...
                lahfb_switcher( array(
                    'title'			=> esc_html__( 'Hide top arrow?', 'lahfb-textdomain' ),
                    'id'			=> 'top_arrow',
                    'default'		=> 'false',
                ));

                lahfb_switcher( array(
                    'title'			=> esc_html__( 'Hide Search box icon?', 'lahfb-textdomain' ),
                    'id'			=> 'searchbox_icon',
                    'default'		=> 'false',
                ));

                lahfb_textfield( array(
                    'title'			=> esc_html__( 'Add custom text besides search icon', 'lahfb-textdomain' ),
                    'id'			=> 'text_beside_icon',
                    'default'		=> 'Search',
                ));

                lahfb_textfield( array(
                    'title'			=> esc_html__( 'Add custom text before search form', 'lahfb-textdomain' ),
                    'id'			=> 'text_before_form',
                    'default'		=> 'Start typing and press Enter to search',
                ));

                lahfb_icon( array(
                    'title'			=> esc_html__( 'Select your design icon', 'lahfb-textdomain' ),
                    'id'			=> 'search_icon'
                ));
                ?>
