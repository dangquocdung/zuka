...
<div class="lahfb-modal-wrap lahfb-modal-edit" data-element-target="login">
	...
	<div class="lahfb-modal-header">
		<h4><?php esc_html_e( 'Login Modal Settings', 'lahfb-textdomain' ); ?></h4>
				...
				<?php
					...
					lahfb_select( array(
						...
						'options'		=> array(
							...
							'icon_text' => esc_html__( 'Icon & Text', 'lahfb-textdomain' ),
						),
						'dependency'	=> array(
					...
					lahfb_textfield( array(
						'title'			=> esc_html__( 'Login Text', 'lahfb-textdomain' ),
						'id'			=> 'login_text',
					...
					lahfb_switcher( array(
						'title'			=> esc_html__( 'Icon floating on the right', 'lahfb-textdomain' ),
						'id'			=> 'login_text_icon',
						'default'		=> 'false',
					));

					lahfb_select( array(
						'title'			=> esc_html__( 'Open Login Form', 'lahfb-textdomain' ),
						'id'			=> 'open_form',
						'default'		=> 'modal',
						'options'		=> array(
					...
					lahfb_switcher( array(
						'title'			=> esc_html__( 'Showing Arrow', 'lahfb-textdomain' ),
						'id'			=> 'show_arrow',
						'default'		=> 'true',
					));

					lahfb_switcher( array(
						'title'			=> esc_html__( 'Showing avatar instead of login icon after login', 'lahfb-textdomain' ),
						'id'			=> 'show_avatar',
						'default'		=> 'true',
					));
