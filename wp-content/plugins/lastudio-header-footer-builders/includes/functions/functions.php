...
if (!function_exists('lahfb_options')) {
    function lahfb_options()
    {
        global $lahfb_options;
        return $lahfb_options;
    }
}
    ...
    function lahfb_login_form() {
        ...
        if ($user_ID) : ?>
            ...
            <div id="user-logged" class="colorskin-custom">
                ...
                <div class="user-welcome"><?php esc_html_e('Welcome','labuilder'); ?> <strong><?php echo esc_html($user_identity) ?></strong></div>
                <ul class="logged-links colorb">
                    <?php if ( class_exists( 'BuddyPress' ) ) { ?>
                        <li><a href="<?php echo bp_loggedin_user_domain(); ?>"><?php esc_html_e('Profile','labuilder'); ?> </a></li>
                        <li><a href="<?php echo esc_url(wp_logout_url(get_permalink())); ?>"><?php esc_html_e('Logout','labuilder'); ?> </a></li>
                    <?php } elseif(function_exists('wc_get_account_menu_items')) { ?>
                        ...
                        <?php endforeach; ?>
                    <?php } else { ?>
                        <li><a href="<?php echo esc_url(home_url('/wp-admin/')); ?>"><?php esc_html_e('Dashboard','labuilder'); ?> </a></li>
                        <li><a href="<?php echo esc_url(home_url('/wp-admin/profile.php')); ?>"><?php esc_html_e('My Profile','labuilder'); ?> </a></li>
                        <li><a href="<?php echo esc_url(wp_logout_url(get_permalink())); ?>"><?php esc_html_e('Logout','labuilder'); ?> </a></li>
                    <?php } ?>
                </ul>
                <div class="clear"></div>
            ...
            <?php if ( is_plugin_active('super-socializer/super_socializer.php') ) { ?>
                ...
                <div class="wn-social-login">
                    ...
                    <div class="wn-or-divider">
                        <span><?php _e( 'or', 'labuilder' ); ?></span>
                    </div>
                </div>
            <?php } ?>
            <h3 id="user-login-title" class="user-login-title"><?php esc_html_e( 'Account Login', 'labuilder' ); ?></h3>
            <div id="user-login">
                <?php
                ...
                <ul class="login-links">
                    ...
                    <li><a href="<?php echo esc_url(wp_lostpassword_url(get_permalink()))?>"><?php esc_html_e('Forget Password?','labuilder'); ?></a></li>
                </ul>
            </div>
        <?php endif;
    }
