...
if ( ! class_exists( 'LAHFB_Ajax' ) ) :
    ...
    class LAHFB_Ajax {
        ...
        private function ajax_save_header_as_template(){
            $content = array();
            $content['lahfb_data_frontend_components'] = !empty($_REQUEST['frontendComponents']) ? $frontendComponents = maybe_unserialize( json_decode( stripslashes( $_REQUEST['frontendComponents'] ), true ) ) : get_option('lahfb_data_frontend_components', array());
