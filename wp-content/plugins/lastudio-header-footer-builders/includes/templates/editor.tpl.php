...
<div class="la-header-builder-wrap wp-clearfix<?php echo esc_attr( $class_frontend_builder ); ?>" id="la-header-builder">
    <?php
    ...
    if(is_admin() && isset($_REQUEST['prebuild_header'])){
        ...
        if(LAHFB_Helper::is_prebuild_header_exists($prebuild_header_key) && !empty($all_existing[$prebuild_header_key]['name'])){
            ...
            echo '<h4>'. esc_html__('You are editing ', 'lahfb-textdomain') .'<strong>'.$all_existing[$prebuild_header_key]['name'].'</strong> <a class="button button-primary" href="'.esc_url(admin_url( 'admin.php?page=lastudio_header_builder_setting' )).'">'. esc_html__('Complete edit') .'</a></h4>';
        }
    }
    ?>
    ...
    <div class="lahfb-actions">
        ...
        <a href="#" id="lahfb-publish" class="button button-primary"><i class="dashicons dashicons-external"></i><?php esc_html_e( 'Publish', 'lahfb-textdomain' ); ?></a>
        ...
        <?php if ( LAHFB_Helper::is_frontend_builder() ) : ?>
            ...
            ?>
            <div class="lahfb-action-collapse lahfb-tooltip lahfb-open" data-tooltip="<?php esc_html_e( 'Toggle', 'lahfb-textdomain' ); ?>"><i class="dashicons dashicons-download"></i></div>
            <a href="<?php echo esc_url($option_page_url) ?>" class="btob-button lahfb-tooltip" data-tooltip="<?php esc_html_e( 'Backend editor', 'lahfb-textdomain' ) ?>"><i class="dashicons dashicons-arrow-left-alt"></i></a>
        <?php else : ?>
        <?php
        ...
        ?>
            <a href="<?php echo esc_url($option_page_url) ?>" id="lahfb-f-editor" class="button button-primary"><i class="dashicons dashicons-arrow-right-alt"></i><?php esc_html_e( 'Front-end Header Builder', 'lahfb-textdomain' ); ?></a>
        <?php endif; ?>

        <a href="#" id="lahfb-vertical-header" class="button" data-header_type="horizontal"><i class="fa fa-bars"></i><span><?php esc_html_e( 'Vertical Header', 'lahfb-textdomain' ); ?></span></a>
        <a href="#" id="lahfb-predefined" class="button lahfb-full-modal-btn" data-modal-target="prebuilds-modal-content"><i class="fa fa-hdd-o"></i><?php esc_html_e( 'Pre-defined Headers', 'lahfb-textdomain' ) ?></a>

        <div class="lahfb-full-modal" data-modal="prebuilds-modal-content">
            <i class="lahfb-full-modal-close fa fa-times"></i>
            <h4><?php esc_html_e( 'Pre-defined Headers', 'lahfb-textdomain' ); ?></h4>
        ...
        <div class="lahfb-import-export">
            <a id="lahfb-saveastpl" class="button button-primary" href="#"><i class="fa fa-floppy-o"></i><?php esc_html_e( 'Save as Header Template', 'lahfb-textdomain' ) ?></a>
            <a id="lahfb-export" class="button" href="<?php echo esc_url( $export_current_header_link ); ?>"><i class="fa fa-cloud-upload"></i><?php esc_html_e( 'Export Header', 'lahfb-textdomain' ) ?></a>
            <div class="lahfb-import-wrap">
                <a class="button lahfb-full-modal-btn" href="#" data-modal-target="import-modal-content"><i class="fa fa-cloud-download"></i><?php esc_html_e( 'Import Header', 'lahfb-textdomain' ) ?></a>
        ...
        <div class="lahfb-tabs-panels">
            ...
            <div class="lahfb-tab-panel lahfb-desktop-panel" id="desktop-view">
                ...
                <div class="lahfb-columns" data-columns="topbar">
                    ...
                    <span class="lahfb-element-name"><?php esc_html_e( 'Topbar Area', 'lahfb-textdomain' ); ?></span>
                ...
                <div class="lahfb-columns" data-columns="row1">
                    ...
                    <span class="lahfb-element-name"><?php esc_html_e( 'Header Area Row 1', 'lahfb-textdomain' ); ?></span>
                    <div class="lahfb-col col-left wp-clearfix" data-align-col="left">
                        <div class="lahfb-elements-place wp-clearfix">
                ...
                <div class="lahfb-columns" data-columns="row2">
                    ...
                    <span class="lahfb-element-name"><?php esc_html_e( 'Header Area Row 2', 'lahfb-textdomain' ); ?></span>
                    <div class="lahfb-col col-left wp-clearfix" data-align-col="left">
                        <div class="lahfb-elements-place wp-clearfix">
                ...
                <div class="lahfb-columns" data-columns="row3">
                    ...
                    <span class="lahfb-element-name"><?php esc_html_e( 'Header Area Row 3', 'lahfb-textdomain' ); ?></span>
                    <div class="lahfb-col col-left wp-clearfix" data-align-col="left">
                        <div class="lahfb-elements-place wp-clearfix">
        ...
        <div class="lahfb-modal-contents-wrap">
            <div class="lahfb-modal-contents w-row">
                ...
                if(!empty($lahfb_preheaders)){
                    ...
                    $lahfb_preheader_opts = array(
                        '' => esc_html__( 'Default', 'lahfb-textdomain' ),
                    );
                }

                lahfb_select( array(
                    'title'			=> esc_html__( 'Save Type', 'lahfb-textdomain' ),
                ...
                lahfb_select( array(
                    'title'			=> esc_html__( 'Select Existing header', 'lahfb-textdomain' ),
                    'id'			=> 'lahfb_save_header_type_existing',
                    'options'		=> $lahfb_preheader_opts
                ));

                lahfb_textfield( array(
                    'title'			=> esc_html__( 'Enter New Header Name', 'lahfb-textdomain' ),
                    'id'			=> 'lahfb_save_header_type_new',
                ));

                lahfb_image( array(
                    'title'			=> esc_html__( 'Custom Image', 'lahfb-textdomain' ),
