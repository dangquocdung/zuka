...
function lahfb_menu( $settings ) {
	...
	if ( ! empty( $menus ) ) :
		...
		$option .= '<span class="lahfb-field-input lahfb-field-select lahfb-field-menu" data-field-name="' . esc_attr( $id ) . '">' . esc_html__( 'No items of this type were found.', 'lahfb-textdomain' ) . '</span>';
	endif;
