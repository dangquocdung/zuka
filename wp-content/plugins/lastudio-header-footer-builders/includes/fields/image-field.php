	...
	$output = '
		<div class="lahfb-field w-col-sm-12' . esc_attr( $placeholder ) . '">
			...
			<div class="lahfb-attach-image">
				...
				<button type="button" class="lahfb-add-image">' . esc_html__( 'Upload', 'lahfb-textdomain' ) . '</button>
				<button type="button" class="lahfb-remove-image">' . esc_html__( 'Remove', 'lahfb-textdomain' ) . '</button>
			</div>
		</div>
	';
